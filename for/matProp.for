...
Module matProp_Mod
  ...
  Type matProps
    ...
    Logical :: E1_def, E2_def, G12_def, v12_def, v23_def
    Logical :: YT_def, SL_def, GYT_def, GSL_def, eta_BK_def
    Logical :: E3_def, G13_def, G23_def, v13_def
    Logical :: cte_def(3)
    Logical :: aPL_def, nPL_def
    Logical :: XT_def, fXT_def, GXT_def, fGXT_def
    Logical :: XC_def, fXC_def, GXC_def, fGXC_def
    Logical :: YC_def, w_kb_def, alpha0_def
    Logical :: cl_def
    Logical :: mu_def
    Logical :: es_def(4), gs_def(4)
    Logical :: schaefer_a6_def
    Logical :: schaefer_b2_def
    Logical :: schaefer_n_def
    Logical :: schaefer_A_def
    Logical :: fatigue_gamma_def, fatigue_epsilon_def, fatigue_eta_def, fatigue_p_mod_def

    ! Calculated properties
    Double Precision :: v21, v31, v32
    Double Precision :: etaL, etaT, ST, phic, alpha0_deg
    ! For shear nonlinearity
    Double Precision :: shear_const_slope_coeff(3,2)    ! For constant stiffness shear law at large strains (row 1 not used, row 2 for plane 12, row 3 for plane 13; cols are slope, intercept)
    Double Precision :: shear_strain_const_slope        ! Copy of the property value for convenience
    Double Precision :: shear_stress_const_slope(3)     ! Stress corresponding to the strain at constant slope (row 1 not used, row 2 for plane 12, row 3 for plane 13)
...
Contains
  ...
  Subroutine initializePhi0(m, Lc, position, phi012, phi013)
    ...
    Else
      Call log%error('Invalid phi0. Found phi0 = '  // trim(str(phi0_input)) // ' See README.')
