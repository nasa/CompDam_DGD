...
Module parameters_Mod
  ...
  Type parameters
    ...
    Double Precision :: shear_strain_const_slope                  ! Shear strain beyond which shear stiffness is held constant (set negative to disable)
    ...
    Double Precision, private :: shear_strain_const_slope_min, shear_strain_const_slope_max
...
Contains
    ...
    ReadLines: Do
      ...
      Else  ! Parse the line in the file
        ...
        Select Case (trim(key))
          ...
          Case ('shear_strain_const_slope')
            Call verifyAndSaveProperty_dbl(trim(key), value, p%shear_strain_const_slope_min, p%shear_strain_const_slope_max, p%shear_strain_const_slope)
  ...
  Subroutine initializeParameters()
    ...
    p%shear_strain_const_slope = 0.1d0  ! 10% strain
    ...
    p%shear_strain_const_slope_min = -one
    p%shear_strain_const_slope_max = one
