...
parameters = {
	"results": [
        ...
        {  # This is a proxy for element deletion; after the element is deleted no additional strain occurs
            "type": "finalValue",
            "identifier":
                {
                    "symbol": "LE33",
            ...
            "referenceValue": finalDisp,  # Since constitutive thickness is 1.0, LE33 = U3
            "tolerance": finalDisp * finalDisp_tol
        },
        {
            "type": "continuous",
